...
public partial class FloodWalkController : BasePlayerController
{
	...
	public Duck Duck;
	public FloodUnstuck Unstuck;


	public FloodWalkController()
	{
		Duck = new Duck( this );
		Unstuck = new FloodUnstuck( this );
	}
	...
	public virtual void StepMove()
	{
		...
		var player = Pawn as FloodPlayer;
		if (player.Team != null)
		{
			mover.Trace = mover.Trace.Size( mins, maxs ).Ignore( Pawn ).WithoutTags(player.Team.TeamTag);
		} else
		{
